 ...
 */
public class Laplacian4Filter3x3 extends Filter {
     ...
     */
    public Laplacian4Filter3x3(PaddingStrategy paddingStrategy,
                                  ImageConversionStrategy conversionStrategy) {
        super(paddingStrategy, conversionStrategy);
        filterMatrix = new double[3][3];

        filterMatrix[0][0] = 0; filterMatrix[1][0] = -1;filterMatrix[2][0] = 0;
        filterMatrix[0][1] = -1; filterMatrix[1][1] = 4; filterMatrix[2][1] = -1;
        filterMatrix[0][2] = 0; filterMatrix[1][2] = -1;filterMatrix[2][2] = 0;
    }
