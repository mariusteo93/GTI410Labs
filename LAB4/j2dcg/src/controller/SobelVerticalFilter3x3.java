 ...
 */
public class SobelVerticalFilter3x3 extends Filter {
     ...
     */
    public SobelVerticalFilter3x3(PaddingStrategy paddingStrategy,
                               ImageConversionStrategy conversionStrategy) {
        super(paddingStrategy, conversionStrategy);
        filterMatrix = new double[3][3];

        filterMatrix[0][0] = -1; filterMatrix[1][0] = -2;filterMatrix[2][0] = -1;
        filterMatrix[0][1] = 0; filterMatrix[1][1] = 0; filterMatrix[2][1] = 0;
        filterMatrix[0][2] = 1; filterMatrix[1][2] = 2;filterMatrix[2][2] = 1;
    }
