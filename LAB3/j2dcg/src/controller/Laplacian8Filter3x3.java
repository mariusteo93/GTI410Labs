 ...
 */
public class Laplacian8Filter3x3 extends Filter {
     ...
     */
    public Laplacian8Filter3x3(PaddingStrategy paddingStrategy,
                                  ImageConversionStrategy conversionStrategy) {
        super(paddingStrategy, conversionStrategy);
        filterMatrix = new double[3][3];

        filterMatrix[0][0] = -1; filterMatrix[1][0] = -1;filterMatrix[2][0] = -1;
        filterMatrix[0][1] = -1; filterMatrix[1][1] = 8; filterMatrix[2][1] = -1;
        filterMatrix[0][2] = -1; filterMatrix[1][2] = -1;filterMatrix[2][2] = -1;
    }
