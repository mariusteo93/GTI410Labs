 ...
 * <p>Copyright: Copyright (c) 2004 Colin Barr�-Brisebois, �ric Paquette</p>
 * <p>Company: ETS - �cole de Technologie Sup�rieure</p>
 * @author unascribed
 * @version $Revision: 1.11 $
 */
public class GaussianFilter3x3 extends Filter {
     ...
     */
    public GaussianFilter3x3(PaddingStrategy paddingStrategy,
                         ImageConversionStrategy conversionStrategy) {
        super(paddingStrategy, conversionStrategy);
        filterMatrix = new double[3][3];

        filterMatrix[0][0] = 1/16;filterMatrix[1][0] =2/16;filterMatrix[2][0] =1/16;
        filterMatrix[0][1] =2/16; filterMatrix[1][1] =4/16;filterMatrix[2][1] =2/16;
        filterMatrix[0][2] = 1/16;filterMatrix[1][2] = 2/16;filterMatrix[2][2] = 1/16;
    }
